...
export default function SubmitAccidentReportPage({
  ...
  const form = useForm<UserSubmitReportFormValues>({
    ...
    onSubmit: async ({ value }) => {
      ...
      try {
        console.log("Submitting accident report with TanStack Form:", parsed.data);
            ...
            <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
              ...
              <CardContent className="space-y-4">
                <form.Field
                  ...
                  validators={{
                    onChange: ({ value }) => 
                      userSubmitReportSchema.shape.description.safeParse(value).success
                        ? undefined
                ...
                <div className="grid grid-cols-1 gap-4">
                  <form.Field
                    ...
                    validators={{
                      onChange: ({ value }) => 
                        userSubmitReportSchema.shape.location.safeParse(value).success
                          ? undefined
        ...
        <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 pt-4 space-y-3">
              ...
              <form.Subscribe selector={(state) => [state.values.injuriesReported]}>
                {([injuriesReported]) =>
                  injuriesReported && (
                    <form.Field name="injuriesDescription" validators={{
                      onChange: ({ value }) => 
                        !value ? "Injury description is required" : undefined
                    }}>
                      {(field) => (
                        <div>
                          <Label className="text-slate-700 dark:text-slate-300 mb-2 block">
